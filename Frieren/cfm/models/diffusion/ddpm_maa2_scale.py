...
from cfm.util import exists, default, count_params, instantiate_from_config
...
class DDPM(pl.LightningModule):
    ...
    def init_from_ckpt(self, path, ignore_keys=list(), only_model=False):
        ...
        print(f'Load Model Only: {only_model}')
...
class DiffusionWrapper(pl.LightningModule):
    def __init__(self, diff_model_config, conditioning_key):
        ...
        assert self.conditioning_key in [None, 'concat', 'crossattn', 'hybrid', 'adm', 'cond_input']

    def forward(self, x, t, c_concat: list = None, c_crossattn: list = None):
        if self.conditioning_key is None or self.conditioning_key == 'cond_input':
