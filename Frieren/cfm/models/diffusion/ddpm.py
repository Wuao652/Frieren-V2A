...
from cfm.models.diffusion.ddim import DDIMSampler
...
class LatentDiffusion(DDPM):
    ...
    def get_first_stage_encoding(self, encoder_posterior):
        if isinstance(encoder_posterior, DiagonalGaussianDistribution) or str(type(encoder_posterior)) == "<class 'adm.modules.stage1_model.model_img.DiagonalGaussianDistribution'>":
